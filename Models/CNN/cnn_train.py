...
# === ADDED START: Robust Import Path ===
# This section ensures that the script can find the 'Models' and 'Datasets' 
# directories by adding the project's root directory to the Python path.
# This prevents ModuleNotFoundError if the script is run directly.
import sys
...
# import tensorflow_addons as tfa  # === DELETED: This library is deprecated ===
import numpy as np
...
class CNN_learner:
    ...
    def train(self, save_path):
        ...
        # === CHANGED: Replaced tfa.optimizers with tf.keras.optimizers ===
        optimizer = tf.keras.optimizers.AdamW(weight_decay=2e-5, learning_rate=1e-3)
